...
_entryData = getArray (missionConfigFile >> "Maverick_PlaneTaxis" >> "Airports" >> worldName >> _fromCfg >> "entryPosition");
_inAir = getNumber (missionConfigFile >> "Maverick_PlaneTaxis" >> "Airports" >> worldName >> _fromCfg >> "inAir");
_exitData = getArray (missionConfigFile >> "Maverick_PlaneTaxis" >> "Airports" >> worldName >> _toCfg >> "exitPosition");
_destID = getNumber (missionConfigFile >> "Maverick_PlaneTaxis" >> "Airports" >> worldName >> _toCfg >> "id");
